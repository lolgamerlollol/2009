--This is the joining script that also works for 2013, etc. 
-- functions -------------------------- 
...
local success, err = pcall(function()	  
	...
	client.Ticket = "" 	 
	playerConnectSucces, player = pcall(function() return client:PlayerConnect(153, "26.133.126.12", 53640, 0, threadSleepTime) end)  
	player.Name = "FUNNYBLOX"  
          game.Players.LocalPlayer.userId = 153 
