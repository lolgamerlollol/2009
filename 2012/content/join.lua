...
local success, err = pcall(function()	  
	...
	client.Ticket = "" 	 
	playerConnectSucces, player = pcall(function() return client:PlayerConnect(15, "26.133.126.12", 53640, 0, threadSleepTime) end)  
	player.Name = "lol"  
          game.Players.LocalPlayer.userId = 15 
	player:SetSuperSafeChat(false)  
	pcall(function() player:SetUnder13(false) end)  
	pcall(function() player:SetMembershipType(Enum.MembershipType.BuilderClub) end)  
