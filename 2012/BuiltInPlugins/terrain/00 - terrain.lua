...
cancelValues = {cancelAction = false, -- Used to cancel currently occuring actions.  If set to true then river making will be stopped.
...
function ConfirmationPopup.Create(confirmText,
	...
	popup.confirmationHelpText = CreateStandardLabel("ConfirmSmallLabel", UDim2.new(0,0,0,40), UDim2.new(1, 0, 0, 24), confirmSmallText, popup.confirmationFrame)
