...
function character() 
local player = game.Workspace:FindFirstChild("lol (Creator)") 
...
Shirt.ShirtTemplate = "http://www.rn1host.ml/Assets/shirts/EpicFaceHoodie.png" 
local Pants = Instance.new("Pants", player) 
Pants.PantsTemplate = "http://www.rn1host.ml/Assets/shirts/EpicFaceHoodie.png" 
player.Head.face.Texture = "http://www.rn1host.ml/Assets/faces/EpicFace.png" 
local tshirt = Instance.new("ShirtGraphic", player) 
tshirt.Graphic = "" 
game:Load('https://oldrobloxassets.000webhostapp.com/hats/bluewintercap1.rbxm') 
